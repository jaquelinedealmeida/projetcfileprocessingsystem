class ReportsController < ApplicationController
  ...
  def show
    ...
    if @document.file.attached?
      ...
      @taxes = {
        icms: doc.at_xpath("//nfe:ICMS00/nfe:vICMS", ns)&.text || "0",
        ipi: doc.at_xpath("//nfe:IPITrib/nfe:vIPI", ns)&.text || "0",
        pis: doc.at_xpath("//nfe:PISNT/nfe:vPIS", ns)&.text || "0",
        cofins: doc.at_xpath("//nfe:COFINSNT/nfe:vCOFINS", ns)&.text || "0"
      }
